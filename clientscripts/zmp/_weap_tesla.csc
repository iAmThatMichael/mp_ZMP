...
tesla_fx_rail( localclientnum )
{
	...
	for( ;; )
	{
		...
		if ( currentweapon != "tesla_gun_mp" && currentweapon != "tesla_gun_upgraded_zm" )
		{
			continue;
		}
...
GetWeaponAmmoClip(localclientnum, currentweapon)
{
	total_ammo = GetTotalAmmo(localclientnum, currentweapon);
	return total_ammo % 4;
}
